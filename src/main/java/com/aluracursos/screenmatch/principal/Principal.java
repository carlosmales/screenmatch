...
public class Principal {
    ...
    private final String API_KEY = "&tt3896198&apikey=79082007";
    ...
    private void buscarSeriePorTitulo(){
        ...
        if(serieBuscada.isPresent()){
            ...
            System.out.println("Serie no encotrada");
        }
    }
    ...
    private void buscarSeriesPorCategoria(){
        System.out.println("Escribe la categoría de la serie que deseas buscar");
